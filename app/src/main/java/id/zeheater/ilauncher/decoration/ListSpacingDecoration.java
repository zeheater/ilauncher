package id.zeheater.ilauncher.decoration;
...
import id.zeheater.ilauncher.R;
...
public class ListSpacingDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListSpacingDecoration(Context context, @DimenRes int spacingDimen) {
        ...
        calculatedSpanCount = context.getResources().getInteger(R.integer.spancount);
        halfSpacing = spacing / 2;
    }

    public ListSpacingDecoration(int spacingPx, int spancount) {
        spacing = spacingPx;
        calculatedSpanCount = spancount;
        halfSpacing = spacing / 2;
    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (itemSpanSize != calculatedSpanCount)
